...
export default function CardeF({imgUrl, title }: CardeProps) {
    return(
        <div className="relative ">
            <div
              className="flex flex-col justify-end   max-h-[667.67px] gap-0  rounded-[3px_0px_0px_0px] left-[279.86px] top-[1755.12px] bg-no-repeat bg-cover w-[100%]  h-screen max-w-[668px]"
              style={{
                backgroundImage:
